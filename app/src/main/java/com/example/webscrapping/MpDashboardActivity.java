...
public class MpDashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_mp_dashboard);
        ...
        myconstituencylinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent postintent = new Intent(MpDashboardActivity.this,PostActivity.class);
        ...
        myfeedlinear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MpDashboardActivity.this,ComplaintActivity.class);
